...
#### A guide covering Apache Lucene Solr including the applications, libraries and tools that will make you better and more efficient with Apache Lucene Solr development.
...
<img src="https://user-images.githubusercontent.com/45159366/137403853-c2f17081-e6cc-47be-8f7e-4fc42c440591.png">
 ...
 Apache Lucene Solr Architecture. Source: [Apache Lucene Solr](https://solr.apache.org/)

# Table of Contents

1. [Apache Lucene Solr Learning Resources](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#Apache-Lucene-Solr-learning-resources)

2. [Apache Lucene Solr Tools, Libraries, and Frameworks](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#Apache-Lucene-Solr-tools-libraries-and-frameworks)

3. [Kubernetes](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#kubernetes)

4. [Docker](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#docker)

5. [Machine Learning](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#machine-learning)

6. [Algorithms](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#Algorithms)

7. [Deep Learning Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#Deep-Learning-Development)

8. [Reinforcement Learning Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#Reinforcement-Learning-Development)

9. [Computer Vision Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#computer-vision-development)

10. [Natural Language Processing (NLP) Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#nlp-development)

11. [Bioinformatics](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#bioinformatics)

12. [Databases](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#databases)

13. [CUDA Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#cuda-development)

14. [MATLAB Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#matlab-development)

15. [Java Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#java-development)

16. [C/C++ Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#cc-development)

17. [C# Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#c-development)

18. [Python Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#python-development)

19. [Go Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#go-development)

20. [Scala Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#scala-development)

21. [R Development](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#r-development)


# Apache Lucene Solr Learning Resources
[Back to the Top](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#table-of-contents)

[Apache Lucene](http://lucene.apache.org) is an open source full-text search engine which can be used with various programming languages.
...
[Introduction to Apache Lucene Course | DevelopIntelligence](https://www.developintelligence.com/catalog/big-data/search/introduction-to-apache-lucene/)

[Apache Lucene Training | DevelopIntelligence](https://www.developintelligence.com/catalog/big-data/apache-lucene/)

[Perform Complex Search Functions in Kibana with Apache Lucene | Pluralsight](https://www.pluralsight.com/courses/complex-search-functions-kibana-apache-lucene)

[Elasticsearch Masterclass [ Elasticsearch 7 update] | Udemy](https://www.udemy.com/course/elasticsearch-masterclass/)

[Apache Cassandra Tutorials and Training | Datastax Academy](https://www.datastax.com/dev/academy)

[Learn Apache Solr with Big Data and Cloud Computing | Udemy](https://www.udemy.com/course/learn-apache-solr-with-big-data-and-cloud-computing/)

[Getting Started with Enterprise Search Using Apache Solr | Pluralsight](https://www.pluralsight.com/courses/enterprise-search-using-apache-solr)

[Sematext Training Courses for Solr & ElasticSearch | Sematext](https://sematext.com/training/)

[Solr Qucikstart](https://solr.apache.org/features.html)

[Solr Developer Resources](https://solr.apache.org/resources.html)

[Apache Solr Reference Guide](https://solr.apache.org/guide/8_10/getting-started.html)

[Solr Community](https://solr.apache.org/community.html)

[Learn Apache Solr | Udemy](https://www.udemy.com/topic/apache-solr/)

[Introduction to Apache Solr | Udemy](https://www.udemy.com/course/learn-apache-solr-8/)

[Apache Solr Training Courses | NobleProg](https://www.nobleprog.com/apache-solr-training)

[Apache Solr: Search Playbook | Pluralsight](https://www.pluralsight.com/courses/apache-solr-search-playbook)
...
# Apache Lucene Solr Tools, Libraries, and Frameworks
[Back to the Top](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide#table-of-contents)
...
[PyLucene](https://lucene.apache.org/pylucene/) is a Python extension for accessing Java Lucene™. Its goal is to allow you to use Lucene's text indexing and searching capabilities from Python. It is API compatible with Java Lucene version 8.9.0 as of June 22nd, 2021.

[Lucene.Net](https://lucenenet.apache.org) is a high performance search engine library for .NET.

[Bleve](https://blevesearch.com) is a full-text search and indexing for Go.

[Bleve Explorer](https://github.com/blevesearch/bleve-explorer) is an example app providing an HTTP/REST/JSON front-end to Bleve.

[Mobile Lucene](https://github.com/lukhnos/mobilelucene) is an experimental fork of Lucene for Android and iOS/macOS.

[Apache Solr Operator™](https://solr.apache.org/operator/) is built to reliably manage Apache Solr™ on Kubernetes.

[SolrCloud](https://solr.apache.org/guide/8_10/getting-started-with-solrcloud.html) is an extension that provides a highly available, fault tolerant environment for distributing your indexed content and query requests across multiple servers. It’s a system in which data is organized into multiple pieces, or shards, that can be hosted on multiple machines, with replicas providing redundancy for both scalability and fault tolerance, and a ZooKeeper server that helps manage the overall structure so that both indexing and search requests can be routed properly.

[Sematext](https://sematext.com) is a monitoring system for all of your development environments in real time. Sematext is great for monitoring SolrCloud, with out of the box dashboards and easy to setup alerts.

[Docker Solr](https://github.com/docker-solr/docker-solr) is a Docker build for Solr, to manage the official Docker hub solr image.

[Spark/Solr](https://github.com/LucidWorks/spark-solr) is a project by [LucidWorks](https://github.com/lucidworks) that includes tools for reading data from Solr as a Spark DataFrame/RDD and indexing objects from Spark into Solr using SolrJ.
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Apache-Lucene-Solr-Guide/pulls).
